# From https://github.com/zachary62/tpc-di-benchmark/blob/main/load_staging_db_script.py
# %%
# importing libraries
import os
import re
...
# %%
cur.execute(open("/home/workspace/src/sql/staging_data_commands.sql", "r").read())
...
# %%
cur.execute(open("/home/workspace/src/sql/staging_finwire_load1.sql", "r").read())
print("Finwire DB tables populated")

# %%
cur.execute(open("/home/workspace/src/sql/load_staging_finwire_db.sql", "r").read())
